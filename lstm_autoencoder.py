...
def detect_anomalies_lstm(input_df, field='Speed'):
    ...
    Args:
        input_df: DataFrame with telemetry.
        field: Field to analyze ('Speed' by default).
    Returns:
        df: DataFrame with reconstruction error and anomaly label.
